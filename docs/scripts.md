...
-   `backend:lint` - this will run rubocop with the --fix flag to automatically fix any linting errors
...
-   `frontend:lint` - this will run prettier with write mode enabled to autocorrect any errors
